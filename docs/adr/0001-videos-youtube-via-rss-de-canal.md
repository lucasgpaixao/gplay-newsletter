...
**Considered options:** (1) RSS por canal — escolhida; (2) Data API com busca derivada das notícias coletadas — rejeitada no MVP por custo operacional e ruído; (3) curadoria manual — rejeitada por não escalar com Actions a cada 6h.
